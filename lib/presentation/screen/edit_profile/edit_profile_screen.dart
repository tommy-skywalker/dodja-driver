                        ...
                        child: Stack(
                          children: [
                            Container(
                              ...
                              child: ClipOval(
                                child: controller.imageFile == null ? MyImageWidget(imageUrl: controller.imageUrl, boxFit: BoxFit.cover, height: Dimensions.space50 + 60, width: Dimensions.space50 + 60, isProfile: true) : Image.file(controller.imageFile!, fit: BoxFit.cover),
                              ),
                            ),
                            Positioned(
                              bottom: 0,
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipOval(
                                          child: Icon(Icons.add_a_photo_outlined, size: Dimensions.space20, color: MyColor.getTextColor()),
                                        ),
                                      ),
                                    ),
                                  ],
