...
import 'package:dodjaerrands_driver/data/controller/auth/forget_password/reset_password_controller.dart';
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Align(alignment: Alignment.center, child: Text(MyStrings.resetPassword.tr, style: boldExtraLarge.copyWith(fontSize: Dimensions.fontExtraLarge + 5))),
