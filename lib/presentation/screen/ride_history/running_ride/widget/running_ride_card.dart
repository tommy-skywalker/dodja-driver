              ...
              children: [
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(MyStrings.rideInProgress.tr, style: boldDefault.copyWith(color: MyColor.bodyText)),
                      Text(DateConverter.estimatedDate(DateTime.now()), style: boldDefault.copyWith(color: MyColor.colorGrey)),
                    ],
                  ),
                ),
