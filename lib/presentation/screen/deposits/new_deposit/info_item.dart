...
class InfoItem extends StatelessWidget {
  ...
  const InfoItem({super.key, required this.firstText, required this.lastText, required this.icon, this.isShowDivider = true});
          ...
          child: Row(
            children: [
              Container(
                ...
                child: SvgPicture.asset(icon, colorFilter: ColorFilter.mode(MyColor.primaryColor, BlendMode.srcIn), height: 20, width: 20),
              ),
