...
class CardButton extends StatelessWidget {
  ...
  const CardButton({super.key, this.text, required this.icon, this.isText = true, this.bgColor = MyColor.primaryColor, this.contentColor = MyColor.colorWhite, required this.press});
