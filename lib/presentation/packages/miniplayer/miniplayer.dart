                      ...
                      child: Material(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            boxShadow: <BoxShadow>[BoxShadow(color: widget.backgroundBoxShadow, blurRadius: widget.elevation, offset: const Offset(0.0, 4))],
                            color: widget.backgroundColor ?? MyColor.screenBgColor,
                          ),
